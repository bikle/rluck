...
curl --user-agent 'Mozilla/4.0 (compatible; MSIE 7.0; Windows NT 5.1)' --cookie-jar cj.txt --cookie cj.txt --no-buffer --output data4git/DIS_${myts}.1hr.csv ${url0}${url2}${url4}${url_stock}${url8}
