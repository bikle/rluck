...
# scp -p /oracle/app/oracle/admin/orcl/dpdump/x5min.dpdmp z:/oracle/app/oracle/admin/orcl/dpdump
# impdp trade/t dumpfile=x5min.dpdmp table_exists_action=replace
