...
# act on the scores:
cd ../openclose/
./oc.bash eur > /pt/s/cron/out/oc_bash.${myts}.txt 2>&1
...
# act on the scores:
cd ../openclose/
./oc.bash gbp > /pt/s/cron/out/oc_bash.${myts}.txt 2>&1
...
# act on the scores:
cd ../openclose/
./oc.bash cad > /pt/s/cron/out/oc_bash.${myts}.txt 2>&1
...
# act on the scores:
cd ../openclose/
./oc.bash chf > /pt/s/cron/out/oc_bash.${myts}.txt 2>&1
...
# act on the scores:
cd ../openclose/
./oc.bash jpy > /pt/s/cron/out/oc_bash.${myts}.txt 2>&1
