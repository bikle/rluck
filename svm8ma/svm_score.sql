...
-- Much of the syntax here was derived from a demo while I was doing a search inside of oracle.com.

-- Please assume that Oracle retains a copyright on this script.

DEFINE target     = 'gatt'
DEFINE model_name = 'svm6'
DEFINE bldtable   = 'bme'
