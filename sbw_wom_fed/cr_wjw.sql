...
,TO_CHAR(a.ydate,'W')week_of_month
,TO_CHAR(a.ydate,'W')wom
FROM fxw a, fxw b
WHERE a.pair = b.pair
...
SELECT wom,MIN(ydate1),COUNT(pair),MAX(ydate2)FROM wjw GROUP BY wom ORDER BY wom ;
