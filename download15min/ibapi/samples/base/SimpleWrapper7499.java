...
public class SimpleWrapper7499 implements EWrapper {
   ...
   public EClientSocket client() { return m_client; }

   protected SimpleWrapper7499() {
      /* */
      initNextOutput();
   ...
   public void connect(int clientId) {
      ...
      host = host != null ? host : "";
      m_client.eConnect(host, 7499, clientId);	
   }
   ...
   private static void attachDisconnectHook(final SimpleWrapper7499 ut) {
