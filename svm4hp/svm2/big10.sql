...
FROM ibfu_t WHERE pair LIKE'%eur%'
ORDER BY ydate
/
...
,LAG(clse,72,NULL)OVER(PARTITION BY pair ORDER BY pair,ydate) lg72
,LEAD(clse,4,NULL)OVER(PARTITION BY pair ORDER BY pair,ydate) ld4
FROM ibfu_t WHERE pair LIKE'%aud%'
ORDER BY ydate
/
...
,LAG(clse,72,NULL)OVER(PARTITION BY pair ORDER BY pair,ydate) lg72
,LEAD(clse,4,NULL)OVER(PARTITION BY pair ORDER BY pair,ydate) ld4
FROM ibfu_t WHERE pair LIKE'%gbp%'
ORDER BY ydate
/
...
,LAG(clse,72,NULL)OVER(PARTITION BY pair ORDER BY pair,ydate) lg72
,LEAD(clse,4,NULL)OVER(PARTITION BY pair ORDER BY pair,ydate) ld4
FROM ibfu_t WHERE pair LIKE'%jpy%'
ORDER BY ydate
/
...
,LAG(clse,72,NULL)OVER(PARTITION BY pair ORDER BY pair,ydate) lg72
,LEAD(clse,4,NULL)OVER(PARTITION BY pair ORDER BY pair,ydate) ld4
FROM ibfu_t WHERE pair LIKE'%cad%'
ORDER BY ydate
/
