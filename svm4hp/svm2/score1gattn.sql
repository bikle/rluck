...
DEFINE model_name = 'forex13'

DELETE fxscores_gattn WHERE score > 0 AND prdate IN(SELECT prdate FROM svmc_apply_prep);

INSERT INTO fxscores_gattn (prdate,score,rundate,pair,ydate)
SELECT
prdate
