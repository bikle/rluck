...
,COUNT(a.pair)row_cnt
FROM
  (SELECT pair,woq,qtr,day_of_week,wgain FROM wjw WHERE ydate2<'2008-01-01')a
...
,COUNT(a.pair)row_cnt
FROM
  (SELECT pair,woq,qtr,day_of_week,wgain FROM wjw WHERE ydate2<'2009-01-01')a
...
,COUNT(a.pair)row_cnt
FROM
  (SELECT pair,woq,qtr,day_of_week,wgain FROM wjw WHERE ydate2<'2010-01-01')a
