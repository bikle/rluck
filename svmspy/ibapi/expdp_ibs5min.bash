...
echo "scp -p /oracle/app/oracle/admin/orcl/dpdump/svmspy_ibs5min.${myts}.dpdmp z3:/oracle/app/oracle/admin/orcl/dpdump/"
# I depend on merge.sql to de-dup ibs5min.
echo "impdp trade/t table_exists_action=append dumpfile=svmspy_ibs5min.${myts}.dpdmp tables=ibs5min"
echo OR
