...
sort AUD_USD* |uniq|grep 1|grep -v finished|awk -F, '{print "aud_usd,"$2","$3}'> ibs_stage.csv
sort EUR_USD* |uniq|grep 1|grep -v finished|awk -F, '{print "eur_usd,"$2","$3}'>> ibs_stage.csv
sort GBP_USD* |uniq|grep 1|grep -v finished|awk -F, '{print "gbp_usd,"$2","$3}'>> ibs_stage.csv
sort USD_JPY* |uniq|grep 1|grep -v finished|awk -F, '{print "usd_jpy,"$2","$3}'>> ibs_stage.csv
sort USD_CAD* |uniq|grep 1|grep -v finished|awk -F, '{print "usd_cad,"$2","$3}'>> ibs_stage.csv
sort USD_CHF* |uniq|grep 1|grep -v finished|awk -F, '{print "usd_chf,"$2","$3}'>> ibs_stage.csv
