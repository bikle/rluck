...
expdp trade/t dumpfile=svmspy_di5.${myts}.dpdmp tables=di5min_stk0,di5min_stk,ibs5min,dukas5min_stk,dukas10min_stk,ibs_old,ibs_dups_old,ibs_stage,di5min_stk_c2,stkscores,ystk,ystk21
...
echo "impdp trade/t table_exists_action=replace dumpfile=svmspy_di5.${myts}.dpdmp tables=ystk"
