...
,egb_g6
FROM fxscores6 s, egb_ms6 m, fxscores6_gattn g
...
,COUNT(score_long)
,CORR(score_long,egb_g6)
,CORR(score_short,egb_g6)
FROM egb_rpt
...
,ROUND(CORR(score_long,egb_g6),2)corr_sg
,MIN(ydate)        min_ydate
,MAX(ydate)        max_ydate
FROM egb_rpt
...
,ROUND(STDDEV(egb_g6),4) std_egb_g6
,ROUND(MAX(egb_g6),4)    max_egb_g6
,ROUND(CORR(score_short,egb_g6),2)corr_sg
,MIN(ydate)        min_ydate
,MAX(ydate)        max_ydate
FROM egb_rpt
