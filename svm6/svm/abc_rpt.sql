...
,abc_g6
FROM fxscores6 s, abc_ms6 m, fxscores6_gattn g
...
,COUNT(score_long)
,CORR(score_long,abc_g6)
,CORR(score_short,abc_g6)
FROM abc_rpt
...
,ROUND(CORR(score_long,abc_g6),2)corr_sg
,MIN(ydate)        min_ydate
,MAX(ydate)        max_ydate
FROM abc_rpt
...
,ROUND(STDDEV(abc_g6),4) std_abc_g6
,ROUND(MAX(abc_g6),4)    max_abc_g6
,ROUND(CORR(score_short,abc_g6),2)corr_sg
,MIN(ydate)        min_ydate
,MAX(ydate)        max_ydate
FROM abc_rpt
