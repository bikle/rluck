...
,aud_g6
FROM fxscores6 s, aud_ms6 m, fxscores6_gattn g
...
,COUNT(score_long)
,CORR(score_long,aud_g6)
,CORR(score_short,aud_g6)
FROM aud_rpt
...
,ROUND(CORR(score_long,aud_g6),2)corr_sg
,MIN(ydate)        min_ydate
,MAX(ydate)        max_ydate
FROM aud_rpt
...
,ROUND(STDDEV(aud_g6),4) std_aud_g6
,ROUND(MAX(aud_g6),4)    max_aud_g6
,ROUND(CORR(score_short,aud_g6),2)corr_sg
,MIN(ydate)        min_ydate
,MAX(ydate)        max_ydate
FROM aud_rpt
